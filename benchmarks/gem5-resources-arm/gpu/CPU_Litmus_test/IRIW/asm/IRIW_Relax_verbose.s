...
// IRIW_Relax.cpp:95:     long long int tid = (long long int)arg;
	ldr	x0, [sp, 24]	// tmp294, arg
	str	x0, [sp, 200]	// tmp294, tid
// IRIW_Relax.cpp:96:     local += tid;
	...
	str	w1, [x0]	// _5, local
// IRIW_Relax.cpp:97:     pthread_barrier_wait(&barrier);
	adrp	x0, barrier	// tmp300,
	add	x0, x0, :lo12:barrier	//, tmp300,
	bl	pthread_barrier_wait		//
// IRIW_Relax.cpp:101: if(tid / DEF_THREADS == 0)
	ldr	x0, [sp, 200]	// tid.2_6, tid
	add	x0, x0, 3	// _7, tid.2_6,
	cmp	x0, 6	// _7,
	bhi	.L4		//,
// IRIW_Relax.cpp:103: 	for (int i = tid; i < DEF_RUNS; i+=DEF_THREADS)
	ldr	x0, [sp, 200]	// tmp301, tid
	str	w0, [sp, 40]	// tmp302, i
// IRIW_Relax.cpp:103: 	for (int i = tid; i < DEF_RUNS; i+=DEF_THREADS)
	b	.L5		//
.L12:
// IRIW_Relax.cpp:107:     		for (long long int j = 0; j < ((*(cpu_rand1+i))); j++);
	str	xzr, [sp, 152]	//, j
// IRIW_Relax.cpp:107:     		for (long long int j = 0; j < ((*(cpu_rand1+i))); j++);
	b	.L6		//
.L7:
...
// IRIW_Relax.cpp:107:     		for (long long int j = 0; j < ((*(cpu_rand1+i))); j++);
	...
	bne	.L7		//,
// IRIW_Relax.cpp:108:     		for (long long int j = 0; j < ((*(cpu_rand1+i))); j++);
	str	xzr, [sp, 160]	//, j
// IRIW_Relax.cpp:108:     		for (long long int j = 0; j < ((*(cpu_rand1+i))); j++);
	b	.L8		//
.L9:
...
// IRIW_Relax.cpp:108:     		for (long long int j = 0; j < ((*(cpu_rand1+i))); j++);
	...
	bne	.L9		//,
// IRIW_Relax.cpp:109:     		for (long long int j = 0; j < ((*(cpu_rand1+i))); j++);
	str	xzr, [sp, 168]	//, j
// IRIW_Relax.cpp:109:     		for (long long int j = 0; j < ((*(cpu_rand1+i))); j++);
	b	.L10		//
.L11:
...
// IRIW_Relax.cpp:109:     		for (long long int j = 0; j < ((*(cpu_rand1+i))); j++);
	...
	bne	.L11		//,
// IRIW_Relax.cpp:110: 	       auto tmp_a = (std::atomic<int>*) &((var+i)->a);
	adrp	x0, var	// tmp325,
...
// IRIW_Relax.cpp:111:     		tmp_a->store(1, std::memory_order_seq_cst);
...
// IRIW_Relax.cpp:103: 	for (int i = tid; i < DEF_RUNS; i+=DEF_THREADS)
	...
	b	.L13		//
.L4:
// IRIW_Relax.cpp:114: else if (tid / DEF_THREADS == 1)
	ldr	x0, [sp, 200]	// tid.10_31, tid
	sub	x0, x0, #4	// _32, tid.10_31,
	cmp	x0, 3	// _32,
	bhi	.L14		//,
// IRIW_Relax.cpp:116: 	for (int i = (tid % DEF_THREADS); i < DEF_RUNS; i+=DEF_THREADS)
...
// IRIW_Relax.cpp:116: 	for (int i = (tid % DEF_THREADS); i < DEF_RUNS; i+=DEF_THREADS)
	b	.L15		//
.L28:
// IRIW_Relax.cpp:119: 		auto tmp_a = (std::atomic<int>*) &((var+i)->a);
	adrp	x0, var	// tmp338,
...
// IRIW_Relax.cpp:120:     		(cpu_res0+i)->r0 = tmp_a->load(std::memory_order_seq_cst);
...
// IRIW_Relax.cpp:121:     		for (int j = 0; j < (*(gpu_rand1+i)); j++);
	str	wzr, [sp, 48]	//, j
// IRIW_Relax.cpp:121:     		for (int j = 0; j < (*(gpu_rand1+i)); j++);
	b	.L17		//
.L18:
...
// IRIW_Relax.cpp:121:     		for (int j = 0; j < (*(gpu_rand1+i)); j++);
	...
	bne	.L18		//,
// IRIW_Relax.cpp:122:     		for (int j = 0; j < (*(gpu_rand1+i)); j++);
	str	wzr, [sp, 52]	//, j
// IRIW_Relax.cpp:122:     		for (int j = 0; j < (*(gpu_rand1+i)); j++);
	b	.L19		//
.L20:
...
// IRIW_Relax.cpp:122:     		for (int j = 0; j < (*(gpu_rand1+i)); j++);
	...
	bne	.L20		//,
// IRIW_Relax.cpp:123:     		for (int j = 0; j < (*(gpu_rand1+i)); j++);
	str	wzr, [sp, 56]	//, j
// IRIW_Relax.cpp:123:     		for (int j = 0; j < (*(gpu_rand1+i)); j++);
	b	.L21		//
.L22:
...
// IRIW_Relax.cpp:123:     		for (int j = 0; j < (*(gpu_rand1+i)); j++);
	...
	bne	.L22		//,
// IRIW_Relax.cpp:124:     		for (int j = 0; j < (*(gpu_rand1+i)); j++);
	str	wzr, [sp, 60]	//, j
// IRIW_Relax.cpp:124:     		for (int j = 0; j < (*(gpu_rand1+i)); j++);
	b	.L23		//
.L24:
...
// IRIW_Relax.cpp:124:     		for (int j = 0; j < (*(gpu_rand1+i)); j++);
	...
	bne	.L24		//,
// IRIW_Relax.cpp:125:     		for (int j = 0; j < (*(gpu_rand1+i)); j++);
	str	wzr, [sp, 64]	//, j
// IRIW_Relax.cpp:125:     		for (int j = 0; j < (*(gpu_rand1+i)); j++);
	b	.L25		//
.L26:
...
// IRIW_Relax.cpp:125:     		for (int j = 0; j < (*(gpu_rand1+i)); j++);
	...
	bne	.L26		//,
// IRIW_Relax.cpp:126:     		auto tmp_b = (std::atomic<int>*) &((var+i)->b); 
	adrp	x0, var	// tmp373,
...
// IRIW_Relax.cpp:127:     		(gpu_res0+i)->r0 = tmp_b->load(std::memory_order_seq_cst);
...
// IRIW_Relax.cpp:116: 	for (int i = (tid % DEF_THREADS); i < DEF_RUNS; i+=DEF_THREADS)
	...
	b	.L13		//
.L14:
// IRIW_Relax.cpp:131: else if (tid / DEF_THREADS == 2)
	ldr	x0, [sp, 200]	// tid.30_86, tid
	sub	x0, x0, #8	// _87, tid.30_86,
	cmp	x0, 3	// _87,
	bhi	.L29		//,
// IRIW_Relax.cpp:133: 	for (int i = (tid % DEF_THREADS); i < DEF_RUNS; i+=DEF_THREADS)
...
// IRIW_Relax.cpp:133: 	for (int i = (tid % DEF_THREADS); i < DEF_RUNS; i+=DEF_THREADS)
	b	.L30		//
.L37:
// IRIW_Relax.cpp:136: 		for (long long int j = 0; j < ((*(cpu_rand2+i))); j++);
	str	xzr, [sp, 176]	//, j
// IRIW_Relax.cpp:136: 		for (long long int j = 0; j < ((*(cpu_rand2+i))); j++);
	b	.L31		//
.L32:
...
// IRIW_Relax.cpp:136: 		for (long long int j = 0; j < ((*(cpu_rand2+i))); j++);
	...
	bne	.L32		//,
// IRIW_Relax.cpp:137:     		for (long long int j = 0; j < ((*(cpu_rand2+i))); j++);
	str	xzr, [sp, 184]	//, j
// IRIW_Relax.cpp:137:     		for (long long int j = 0; j < ((*(cpu_rand2+i))); j++);
	b	.L33		//
.L34:
...
// IRIW_Relax.cpp:137:     		for (long long int j = 0; j < ((*(cpu_rand2+i))); j++);
	...
	bne	.L34		//,
// IRIW_Relax.cpp:138:     		for (long long int j = 0; j < ((*(cpu_rand2+i))); j++);
	str	xzr, [sp, 192]	//, j
// IRIW_Relax.cpp:138:     		for (long long int j = 0; j < ((*(cpu_rand2+i))); j++);
	b	.L35		//
.L36:
...
// IRIW_Relax.cpp:138:     		for (long long int j = 0; j < ((*(cpu_rand2+i))); j++);
	...
	bne	.L36		//,
// IRIW_Relax.cpp:139:     		auto tmp_b = (std::atomic<int>*) &((var+i)->b);
	adrp	x0, var	// tmp409,
...
// IRIW_Relax.cpp:140:     		tmp_b->store(1, std::memory_order_seq_cst);
...
// IRIW_Relax.cpp:133: 	for (int i = (tid % DEF_THREADS); i < DEF_RUNS; i+=DEF_THREADS)
	...
	b	.L13		//
.L29:
// IRIW_Relax.cpp:145: 	for (int i = (tid % DEF_THREADS); i < DEF_RUNS; i+=DEF_THREADS)
...
// IRIW_Relax.cpp:145: 	for (int i = (tid % DEF_THREADS); i < DEF_RUNS; i+=DEF_THREADS)
	b	.L38		//
.L51:
// IRIW_Relax.cpp:148: 		auto tmp_b = (std::atomic<int>*) &((var+i)->b);
	adrp	x0, var	// tmp423,
...
// IRIW_Relax.cpp:149: 		(gpu_res1+i)->r0 = tmp_b->load(std::memory_order_seq_cst);
...
// IRIW_Relax.cpp:150: 		for (int j = 0; j < (*(gpu_rand2+i)); j++);
	str	wzr, [sp, 76]	//, j
// IRIW_Relax.cpp:150: 		for (int j = 0; j < (*(gpu_rand2+i)); j++);
	b	.L40		//
.L41:
...
// IRIW_Relax.cpp:150: 		for (int j = 0; j < (*(gpu_rand2+i)); j++);
	...
	bne	.L41		//,
// IRIW_Relax.cpp:151:     		for (int j = 0; j < (*(gpu_rand2+i)); j++);
	str	wzr, [sp, 80]	//, j
// IRIW_Relax.cpp:151:     		for (int j = 0; j < (*(gpu_rand2+i)); j++);
	b	.L42		//
.L43:
...
// IRIW_Relax.cpp:151:     		for (int j = 0; j < (*(gpu_rand2+i)); j++);
	...
	bne	.L43		//,
// IRIW_Relax.cpp:152:     		for (int j = 0; j < (*(gpu_rand2+i)); j++);
	str	wzr, [sp, 84]	//, j
// IRIW_Relax.cpp:152:     		for (int j = 0; j < (*(gpu_rand2+i)); j++);
	b	.L44		//
.L45:
...
// IRIW_Relax.cpp:152:     		for (int j = 0; j < (*(gpu_rand2+i)); j++);
	...
	bne	.L45		//,
// IRIW_Relax.cpp:153:     		for (int j = 0; j < (*(gpu_rand2+i)); j++);
	str	wzr, [sp, 88]	//, j
// IRIW_Relax.cpp:153:     		for (int j = 0; j < (*(gpu_rand2+i)); j++);
	b	.L46		//
.L47:
...
// IRIW_Relax.cpp:153:     		for (int j = 0; j < (*(gpu_rand2+i)); j++);
	...
	bne	.L47		//,
// IRIW_Relax.cpp:154:     		for (int j = 0; j < (*(gpu_rand2+i)); j++);
	str	wzr, [sp, 92]	//, j
// IRIW_Relax.cpp:154:     		for (int j = 0; j < (*(gpu_rand2+i)); j++);
	b	.L48		//
.L49:
...
// IRIW_Relax.cpp:154:     		for (int j = 0; j < (*(gpu_rand2+i)); j++);
	...
	bne	.L49		//,
// IRIW_Relax.cpp:155:     		auto tmp_a = (std::atomic<int>*) &((var+i)->a);
	adrp	x0, var	// tmp459,
...
// IRIW_Relax.cpp:156:     		(cpu_res1+i)->r0 = tmp_a->load(std::memory_order_seq_cst);
...
// IRIW_Relax.cpp:145: 	for (int i = (tid % DEF_THREADS); i < DEF_RUNS; i+=DEF_THREADS)
	...
	ble	.L51		//,
.L13:
// IRIW_Relax.cpp:163:     return (void*)local;
...
// IRIW_Relax.cpp:169:     unsigned res_cpu0_gpu0 = 0;
	str	wzr, [sp, 44]	//, res_cpu0_gpu0
// IRIW_Relax.cpp:170:     unsigned res_cpu1_gpu0 = 0;
	str	wzr, [sp, 48]	//, res_cpu1_gpu0
// IRIW_Relax.cpp:171:     unsigned res_cpu0_gpu1 = 0;
	str	wzr, [sp, 52]	//, res_cpu0_gpu1
// IRIW_Relax.cpp:172:     unsigned res_cpu1_gpu1 = 0;
	str	wzr, [sp, 56]	//, res_cpu1_gpu1
// IRIW_Relax.cpp:173:     unsigned res_cpu2_gpu2 = 0;
	str	wzr, [sp, 60]	//, res_cpu2_gpu2
// IRIW_Relax.cpp:175:     unsigned rst_cpu0_gpu0 = 0;
	str	wzr, [sp, 64]	//, rst_cpu0_gpu0
// IRIW_Relax.cpp:176:     unsigned rst_cpu1_gpu0 = 0;
	str	wzr, [sp, 68]	//, rst_cpu1_gpu0
// IRIW_Relax.cpp:177:     unsigned rst_cpu0_gpu1 = 0;
	str	wzr, [sp, 72]	//, rst_cpu0_gpu1
// IRIW_Relax.cpp:178:     unsigned rst_cpu1_gpu1 = 0;
	str	wzr, [sp, 76]	//, rst_cpu1_gpu1
// IRIW_Relax.cpp:179:     unsigned rst_cpu2_gpu2 = 0;
	str	wzr, [sp, 80]	//, rst_cpu2_gpu2
// IRIW_Relax.cpp:180:     int pass = 0;
	str	wzr, [sp, 84]	//, pass
// IRIW_Relax.cpp:181:     int failure = 0;
	str	wzr, [sp, 88]	//, failure
// IRIW_Relax.cpp:183:     for (auto i = 0; i < t_range; ++i) {
	str	wzr, [sp, 92]	//, i
// IRIW_Relax.cpp:183:     for (auto i = 0; i < t_range; ++i) {
	b	.L54		//
.L85:
// IRIW_Relax.cpp:184:         if ((cpu_res0[i].r0 == 0) && (gpu_res0[i].r0 == 0)) {
...
// IRIW_Relax.cpp:183:     for (auto i = 0; i < t_range; ++i) {
	...
	bhi	.L85		//,
// IRIW_Relax.cpp:219:      	std::cout << "Pass Test: " << pass << std::endl;
	adrp	x0, .LC0	// tmp323,
...
// IRIW_Relax.cpp:219:      	std::cout << "Pass Test: " << pass << std::endl;
	...
	mov	x0, x2	//, _103
	bl	_ZNSolsEPFRSoS_E		//
// IRIW_Relax.cpp:220: 	std::cout << "Failure Test: " << failure << std::endl;
	adrp	x0, .LC1	// tmp326,
...
// IRIW_Relax.cpp:220: 	std::cout << "Failure Test: " << failure << std::endl;
	...
	mov	x0, x2	//, _105
	bl	_ZNSolsEPFRSoS_E		//
// IRIW_Relax.cpp:221:         if (failure != 0)
	ldr	w0, [sp, 88]	// tmp329, failure
	cmp	w0, 0	// tmp329,
	beq	.L86		//,
// IRIW_Relax.cpp:223: 		std::cout << "=========================================================================" << std::endl;
	adrp	x0, .LC2	// tmp330,
...
// IRIW_Relax.cpp:223: 		std::cout << "=========================================================================" << std::endl;
	...
	mov	x0, x2	//, _106
	bl	_ZNSolsEPFRSoS_E		//
// IRIW_Relax.cpp:224:         	std::cout << "	\t CPU-Only IRIW-sys Allowed  \t " << std::endl;						
	adrp	x0, .LC3	// tmp333,
...
// IRIW_Relax.cpp:224:         	std::cout << "	\t CPU-Only IRIW-sys Allowed  \t " << std::endl;						
	...
	mov	x0, x2	//, _107
	bl	_ZNSolsEPFRSoS_E		//
// IRIW_Relax.cpp:225:         	std::cout << "=========================================================================" << std::endl;  
	adrp	x0, .LC2	// tmp336,
...
// IRIW_Relax.cpp:225:         	std::cout << "=========================================================================" << std::endl;  
	...
	b	.L87		//
.L86:
// IRIW_Relax.cpp:229: 		std::cout << "=========================================================================" << std::endl;
	adrp	x0, .LC2	// tmp339,
...
// IRIW_Relax.cpp:229: 		std::cout << "=========================================================================" << std::endl;
	...
	mov	x0, x2	//, _109
	bl	_ZNSolsEPFRSoS_E		//
// IRIW_Relax.cpp:230:         	std::cout << "	\t CPU-Only IRIW-sys Disallowed  \t " << std::endl;						
	adrp	x0, .LC4	// tmp342,
...
// IRIW_Relax.cpp:230:         	std::cout << "	\t CPU-Only IRIW-sys Disallowed  \t " << std::endl;						
	...
	mov	x0, x2	//, _110
	bl	_ZNSolsEPFRSoS_E		//
// IRIW_Relax.cpp:231:         	std::cout << "=========================================================================" << std::endl;  
	adrp	x0, .LC2	// tmp345,
...
// IRIW_Relax.cpp:231:         	std::cout << "=========================================================================" << std::endl;  
	...
	bl	_ZNSolsEPFRSoS_E		//
.L87:
// IRIW_Relax.cpp:234:     if ((!res_cpu1_gpu0) && (!rst_cpu0_gpu1)) {
...
// IRIW_Relax.cpp:234:     if ((!res_cpu1_gpu0) && (!rst_cpu0_gpu1)) {
	...
	cmp	w0, 0	// tmp349,
	bne	.L88		//,
// IRIW_Relax.cpp:235:         std::cout << "Success!" << std::endl;
	adrp	x0, .LC5	// tmp350,
...
// IRIW_Relax.cpp:235:         std::cout << "Success!" << std::endl;
	...
	mov	x0, x2	//, _112
	bl	_ZNSolsEPFRSoS_E		//
// IRIW_Relax.cpp:236:         std::cout << "Count (a:0 and b:0): " << res_cpu0_gpu0 << std::endl;
	adrp	x0, .LC6	// tmp353,
...
// IRIW_Relax.cpp:236:         std::cout << "Count (a:0 and b:0): " << res_cpu0_gpu0 << std::endl;
	...
	mov	x0, x2	//, _114
	bl	_ZNSolsEPFRSoS_E		//
// IRIW_Relax.cpp:237:         std::cout << "Count (a:1 and b:0): " << res_cpu1_gpu0 << std::endl;
	adrp	x0, .LC7	// tmp356,
...
// IRIW_Relax.cpp:237:         std::cout << "Count (a:1 and b:0): " << res_cpu1_gpu0 << std::endl;
	...
	mov	x0, x2	//, _116
	bl	_ZNSolsEPFRSoS_E		//
// IRIW_Relax.cpp:238:         std::cout << "Count (a:0 and b:1): " << res_cpu0_gpu1 << std::endl;
	adrp	x0, .LC8	// tmp359,
...
// IRIW_Relax.cpp:238:         std::cout << "Count (a:0 and b:1): " << res_cpu0_gpu1 << std::endl;
	...
	mov	x0, x2	//, _118
	bl	_ZNSolsEPFRSoS_E		//
// IRIW_Relax.cpp:239:         std::cout << "Count (a:1 and b:1): " << res_cpu1_gpu1 << std::endl;
	adrp	x0, .LC9	// tmp362,
...
// IRIW_Relax.cpp:239:         std::cout << "Count (a:1 and b:1): " << res_cpu1_gpu1 << std::endl;
	...
	mov	x0, x2	//, _120
	bl	_ZNSolsEPFRSoS_E		//
// IRIW_Relax.cpp:240:         std::cout << "Count (r0:2 and r1:2): " << res_cpu2_gpu2 << std::endl; 
	adrp	x0, .LC10	// tmp365,
...
// IRIW_Relax.cpp:240:         std::cout << "Count (r0:2 and r1:2): " << res_cpu2_gpu2 << std::endl; 
	...
	mov	x0, x2	//, _122
	bl	_ZNSolsEPFRSoS_E		//
// IRIW_Relax.cpp:241:         std::cout << "Count (a:0 and b:0): " << rst_cpu0_gpu0 << std::endl;
	adrp	x0, .LC6	// tmp368,
...
// IRIW_Relax.cpp:241:         std::cout << "Count (a:0 and b:0): " << rst_cpu0_gpu0 << std::endl;
	...
	mov	x0, x2	//, _124
	bl	_ZNSolsEPFRSoS_E		//
// IRIW_Relax.cpp:242:         std::cout << "Count (a:1 and b:0): " << rst_cpu1_gpu0 << std::endl;
	adrp	x0, .LC7	// tmp371,
...
// IRIW_Relax.cpp:242:         std::cout << "Count (a:1 and b:0): " << rst_cpu1_gpu0 << std::endl;
	...
	mov	x0, x2	//, _126
	bl	_ZNSolsEPFRSoS_E		//
// IRIW_Relax.cpp:243:         std::cout << "Count (a:0 and b:1): " << rst_cpu0_gpu1 << std::endl;
	adrp	x0, .LC8	// tmp374,
...
// IRIW_Relax.cpp:243:         std::cout << "Count (a:0 and b:1): " << rst_cpu0_gpu1 << std::endl;
	...
	mov	x0, x2	//, _128
	bl	_ZNSolsEPFRSoS_E		//
// IRIW_Relax.cpp:244:         std::cout << "Count (a:1 and b:1): " << rst_cpu1_gpu1 << std::endl;
	adrp	x0, .LC9	// tmp377,
...
// IRIW_Relax.cpp:244:         std::cout << "Count (a:1 and b:1): " << rst_cpu1_gpu1 << std::endl;
	...
	mov	x0, x2	//, _130
	bl	_ZNSolsEPFRSoS_E		//
// IRIW_Relax.cpp:245:         std::cout << "Count (r0:2 and r1:2): " << rst_cpu2_gpu2 << std::endl;
	adrp	x0, .LC10	// tmp380,
...
// IRIW_Relax.cpp:245:         std::cout << "Count (r0:2 and r1:2): " << rst_cpu2_gpu2 << std::endl;
	...
	mov	x0, x2	//, _132
	bl	_ZNSolsEPFRSoS_E		//
// IRIW_Relax.cpp:248:         return 0;
	mov	w0, 0	// _188,
	b	.L89		//
.L88:
// IRIW_Relax.cpp:250:         std::cout << "Fail!" << std::endl;
	adrp	x0, .LC11	// tmp383,
...
// IRIW_Relax.cpp:250:         std::cout << "Fail!" << std::endl;
	...
	mov	x0, x2	//, _133
	bl	_ZNSolsEPFRSoS_E		//
// IRIW_Relax.cpp:251:         std::cout << "Count (a:0 and b:0): " << res_cpu0_gpu0 << std::endl;
	adrp	x0, .LC6	// tmp386,
...
// IRIW_Relax.cpp:251:         std::cout << "Count (a:0 and b:0): " << res_cpu0_gpu0 << std::endl;
	...
	mov	x0, x2	//, _135
	bl	_ZNSolsEPFRSoS_E		//
// IRIW_Relax.cpp:252:         std::cout << "Count (a:1 and b:0): " << res_cpu1_gpu0 << std::endl;
	adrp	x0, .LC7	// tmp389,
...
// IRIW_Relax.cpp:252:         std::cout << "Count (a:1 and b:0): " << res_cpu1_gpu0 << std::endl;
	...
	mov	x0, x2	//, _137
	bl	_ZNSolsEPFRSoS_E		//
// IRIW_Relax.cpp:253:         std::cout << "Count (a:0 and b:1): " << res_cpu0_gpu1 << std::endl;
	adrp	x0, .LC8	// tmp392,
...
// IRIW_Relax.cpp:253:         std::cout << "Count (a:0 and b:1): " << res_cpu0_gpu1 << std::endl;
	...
	mov	x0, x2	//, _139
	bl	_ZNSolsEPFRSoS_E		//
// IRIW_Relax.cpp:254:         std::cout << "Count (a:1 and b:1): " << res_cpu1_gpu1 << std::endl;
	adrp	x0, .LC9	// tmp395,
...
// IRIW_Relax.cpp:254:         std::cout << "Count (a:1 and b:1): " << res_cpu1_gpu1 << std::endl;
	...
	mov	x0, x2	//, _141
	bl	_ZNSolsEPFRSoS_E		//
// IRIW_Relax.cpp:255:         std::cout << "Count (r0:2 and r1:2): " << res_cpu2_gpu2 << std::endl;
	adrp	x0, .LC10	// tmp398,
...
// IRIW_Relax.cpp:255:         std::cout << "Count (r0:2 and r1:2): " << res_cpu2_gpu2 << std::endl;
	...
	mov	x0, x2	//, _143
	bl	_ZNSolsEPFRSoS_E		//
// IRIW_Relax.cpp:256:         std::cout << "Count (a:0 and b:0): " << rst_cpu0_gpu0 << std::endl;
	adrp	x0, .LC6	// tmp401,
...
// IRIW_Relax.cpp:256:         std::cout << "Count (a:0 and b:0): " << rst_cpu0_gpu0 << std::endl;
	...
	mov	x0, x2	//, _145
	bl	_ZNSolsEPFRSoS_E		//
// IRIW_Relax.cpp:257:         std::cout << "Count (a:1 and b:0): " << rst_cpu1_gpu0 << std::endl;
	adrp	x0, .LC7	// tmp404,
...
// IRIW_Relax.cpp:257:         std::cout << "Count (a:1 and b:0): " << rst_cpu1_gpu0 << std::endl;
	...
	mov	x0, x2	//, _147
	bl	_ZNSolsEPFRSoS_E		//
// IRIW_Relax.cpp:258:         std::cout << "Count (a:0 and b:1): " << rst_cpu0_gpu1 << std::endl;
	adrp	x0, .LC8	// tmp407,
...
// IRIW_Relax.cpp:258:         std::cout << "Count (a:0 and b:1): " << rst_cpu0_gpu1 << std::endl;
	...
	mov	x0, x2	//, _149
	bl	_ZNSolsEPFRSoS_E		//
// IRIW_Relax.cpp:259:         std::cout << "Count (a:1 and b:1): " << rst_cpu1_gpu1 << std::endl;
	adrp	x0, .LC9	// tmp410,
...
// IRIW_Relax.cpp:259:         std::cout << "Count (a:1 and b:1): " << rst_cpu1_gpu1 << std::endl;
	...
	mov	x0, x2	//, _151
	bl	_ZNSolsEPFRSoS_E		//
// IRIW_Relax.cpp:260:         std::cout << "Count (r0:2 and r1:2): " << rst_cpu2_gpu2 << std::endl;
	adrp	x0, .LC10	// tmp413,
...
// IRIW_Relax.cpp:271: {
	...
	mov	x1, 0	// tmp352
// IRIW_Relax.cpp:272:     if (argc != 2) { 
	ldr	w0, [sp, 28]	// tmp194, argc
	cmp	w0, 2	// tmp194,
	beq	.L91		//,
// IRIW_Relax.cpp:273:         printf("usage: %s <thread_count>\n", argv[0]);
	...
	bl	printf		//
// IRIW_Relax.cpp:274:         exit(1);
	mov	w0, 1	//,
	bl	exit		//
.L91:
// IRIW_Relax.cpp:276:     int thread_count = atoi(argv[1]);
...
// IRIW_Relax.cpp:278:     printf("Starting %d threads...\n", thread_count);
	ldr	w1, [sp, 72]	//, thread_count
	adrp	x0, .LC13	// tmp198,
	add	x0, x0, :lo12:.LC13	//, tmp198,
	bl	printf		//
// IRIW_Relax.cpp:280: auto num_iterations = DEF_RUNS; 
	mov	w0, 34464	// tmp199,
	movk	w0, 0x1, lsl 16	// tmp199,,
	str	w0, [sp, 76]	// tmp199, num_iterations
// IRIW_Relax.cpp:282: auto t_range = num_iterations;
	ldr	w0, [sp, 76]	// tmp200, num_iterations
	str	w0, [sp, 80]	// tmp200, t_range
// IRIW_Relax.cpp:284:    var = (struct s_var*)malloc(sizeof(struct s_var) * t_range);
...
// IRIW_Relax.cpp:284:    var = (struct s_var*)malloc(sizeof(struct s_var) * t_range);
	...
	str	x1, [x0]	// _6, var
// IRIW_Relax.cpp:286:     for (auto i = 0; i < t_range; ++i) {
	str	wzr, [sp, 44]	//, i
// IRIW_Relax.cpp:286:     for (auto i = 0; i < t_range; ++i) {
	b	.L92		//
.L93:
// IRIW_Relax.cpp:287:         var[i].a = 0;
	adrp	x0, var	// tmp205,
...
// IRIW_Relax.cpp:286:     for (auto i = 0; i < t_range; ++i) {
	...
	blt	.L93		//,
// IRIW_Relax.cpp:292:    cpu_res0 = (struct r_cpu0*)malloc(sizeof(struct r_cpu0) * t_range);
...
// IRIW_Relax.cpp:294:     for (auto i = 0; i < t_range; ++i) {
	str	wzr, [sp, 48]	//, i
// IRIW_Relax.cpp:294:     for (auto i = 0; i < t_range; ++i) {
	b	.L94		//
.L95:
// IRIW_Relax.cpp:295:         cpu_res0[i].r0 = 2;
...
// IRIW_Relax.cpp:294:     for (auto i = 0; i < t_range; ++i) {
	...
	blt	.L95		//,
// IRIW_Relax.cpp:299:     gpu_res0 = (struct r_gpu0*)malloc(sizeof(struct r_gpu0) * t_range);
...
// IRIW_Relax.cpp:301:     for (auto i = 0; i < t_range; ++i) {
	str	wzr, [sp, 52]	//, i
// IRIW_Relax.cpp:301:     for (auto i = 0; i < t_range; ++i) {
	b	.L96		//
.L97:
// IRIW_Relax.cpp:302:         gpu_res0[i].r0 = 2;
...
// IRIW_Relax.cpp:301:     for (auto i = 0; i < t_range; ++i) {
	...
	blt	.L97		//,
// IRIW_Relax.cpp:305:     cpu_res1 = (struct r_cpu1*)malloc(sizeof(struct r_cpu1) * t_range);
...
// IRIW_Relax.cpp:307:     for (auto i = 0; i < t_range; ++i) {
	str	wzr, [sp, 56]	//, i
// IRIW_Relax.cpp:307:     for (auto i = 0; i < t_range; ++i) {
	b	.L98		//
.L99:
// IRIW_Relax.cpp:308:         cpu_res1[i].r0 = 2;
...
// IRIW_Relax.cpp:307:     for (auto i = 0; i < t_range; ++i) {
	...
	blt	.L99		//,
// IRIW_Relax.cpp:312:     gpu_res1 = (struct r_gpu1*)malloc(sizeof(struct r_gpu1) * t_range);
...
// IRIW_Relax.cpp:314:     for (auto i = 0; i < t_range; ++i) {
	str	wzr, [sp, 60]	//, i
// IRIW_Relax.cpp:314:     for (auto i = 0; i < t_range; ++i) {
	b	.L100		//
.L101:
// IRIW_Relax.cpp:315:         gpu_res1[i].r0 = 2;
...
// IRIW_Relax.cpp:314:     for (auto i = 0; i < t_range; ++i) {
	...
	blt	.L101		//,
// IRIW_Relax.cpp:323:    cpu_rand1 = (unsigned*)malloc(sizeof(unsigned) * t_range);
...
// IRIW_Relax.cpp:324:    gpu_rand1 = (unsigned*)malloc(sizeof(unsigned) * t_range);
...
// IRIW_Relax.cpp:325:    cpu_rand2 = (unsigned*)malloc(sizeof(unsigned) * t_range);
...
// IRIW_Relax.cpp:326:    gpu_rand2 = (unsigned*)malloc(sizeof(unsigned) * t_range);
...
// IRIW_Relax.cpp:328: for (int iter = 0; iter < num_iterations; iter++) {
	str	wzr, [sp, 64]	//, iter
// IRIW_Relax.cpp:328: for (int iter = 0; iter < num_iterations; iter++) {
	b	.L102		//
.L103:
// IRIW_Relax.cpp:330:             auto g_tid = iter;
	ldr	w0, [sp, 64]	// tmp264, iter
	str	w0, [sp, 96]	// tmp264, g_tid
// IRIW_Relax.cpp:333:             unsigned rand_val = std::rand() % RAND_RANGE;
	bl	rand		//
	mov	w2, w0	// _55,
// IRIW_Relax.cpp:333:             unsigned rand_val = std::rand() % RAND_RANGE;
	mov	w0, 26215	// tmp266,
...
// IRIW_Relax.cpp:335:             cpu_rand1[g_tid] = rand_val;
...
// IRIW_Relax.cpp:338:             rand_val = std::rand() % RAND_RANGE;
	bl	rand		//
	mov	w2, w0	// _61,
// IRIW_Relax.cpp:338:             rand_val = std::rand() % RAND_RANGE;
	mov	w0, 26215	// tmp277,
...
// IRIW_Relax.cpp:340:             gpu_rand1[g_tid] = rand_val;
...
// IRIW_Relax.cpp:343:             rand_val = std::rand() % RAND_RANGE;
	bl	rand		//
	mov	w2, w0	// _67,
// IRIW_Relax.cpp:343:             rand_val = std::rand() % RAND_RANGE;
	mov	w0, 26215	// tmp288,
...
// IRIW_Relax.cpp:345:             cpu_rand2[g_tid] = rand_val;
...
// IRIW_Relax.cpp:348:             rand_val = std::rand() % RAND_RANGE;
	bl	rand		//
	mov	w2, w0	// _73,
// IRIW_Relax.cpp:348:             rand_val = std::rand() % RAND_RANGE;
	mov	w0, 26215	// tmp299,
...
// IRIW_Relax.cpp:350:             gpu_rand2[g_tid] = rand_val;
...
// IRIW_Relax.cpp:328: for (int iter = 0; iter < num_iterations; iter++) {
	...
	blt	.L103		//,
// IRIW_Relax.cpp:353:     std::cout << "Random thread launch delays generated" << std::endl;
	adrp	x0, .LC14	// tmp313,
...
// IRIW_Relax.cpp:353:     std::cout << "Random thread launch delays generated" << std::endl;
	...
	mov	x0, x2	//, _79
	bl	_ZNSolsEPFRSoS_E		//
// IRIW_Relax.cpp:358:     pthread_t* threads = (pthread_t*)calloc(thread_count, sizeof(pthread_t));
	ldrsw	x0, [sp, 72]	// _80, thread_count
	mov	x1, 8	//,
	bl	calloc		//
	str	x0, [sp, 112]	// tmp316, threads
// IRIW_Relax.cpp:359:     pthread_barrier_init(&barrier, NULL, (thread_count));
...
// IRIW_Relax.cpp:360:     assert(threads != NULL);
...
// IRIW_Relax.cpp:360:     assert(threads != NULL);
	...
	bl	__assert_fail		//
.L104:
// IRIW_Relax.cpp:361:     for (i = 1 ; i < thread_count; i++) {
	mov	w0, 1	// tmp322,
	str	w0, [sp, 68]	// tmp322, i
// IRIW_Relax.cpp:361:     for (i = 1 ; i < thread_count; i++) {
	b	.L105		//
.L107:
// IRIW_Relax.cpp:362:         int createResult = pthread_create(&threads[i], 
...
// IRIW_Relax.cpp:366:         assert(createResult == 0);
...
// IRIW_Relax.cpp:361:     for (i = 1 ; i < thread_count; i++) {
	...
	blt	.L107		//,
// IRIW_Relax.cpp:369:     long long int local = (long long int)runIRIW((void*)0);
	mov	x0, 0	//,
	bl	_Z7runIRIWPv		//
// IRIW_Relax.cpp:369:     long long int local = (long long int)runIRIW((void*)0);
	str	x0, [sp, 104]	// _88, local
// IRIW_Relax.cpp:370:     printf("local[0] = %lld\n", local);
	ldr	x0, [sp, 104]	// local.113_89, local
	mov	x1, x0	//, local.113_89
	adrp	x0, .LC19	// tmp333,
	add	x0, x0, :lo12:.LC19	//, tmp333,
	bl	printf		//
// IRIW_Relax.cpp:377:     for (i = 1 ; i < thread_count; i++) {
	mov	w0, 1	// tmp334,
	str	w0, [sp, 68]	// tmp334, i
// IRIW_Relax.cpp:377:     for (i = 1 ; i < thread_count; i++) {
	b	.L108		//
.L110:
// IRIW_Relax.cpp:378:         int joinResult = pthread_join(threads[i], 
	ldrsw	x0, [sp, 68]	// _90, i
// IRIW_Relax.cpp:378:         int joinResult = pthread_join(threads[i], 
	lsl	x0, x0, 3	// _91, _90,
...
// IRIW_Relax.cpp:380:         assert(joinResult == 0);
...
// IRIW_Relax.cpp:380:         assert(joinResult == 0);
	...
	bl	__assert_fail		//
.L109:
// IRIW_Relax.cpp:381:         printf("local[%d] = %lld\n", i, local);
...
// IRIW_Relax.cpp:377:     for (i = 1 ; i < thread_count; i++) {
	...
	blt	.L110		//,
// IRIW_Relax.cpp:384:     std::cout << "Validating..." << std::flush;
	adrp	x0, .LC22	// tmp346,
...
// IRIW_Relax.cpp:384:     std::cout << "Validating..." << std::flush;
	...
	mov	x0, x2	//, _95
	bl	_ZNSolsEPFRSoS_E		//
// IRIW_Relax.cpp:385:     int res = check_output(t_range);
	ldr	w0, [sp, 80]	// t_range.115_96, t_range
	bl	_Z12check_outputj		//
	str	w0, [sp, 84]	// _161, res
// IRIW_Relax.cpp:388:         free(threads);
	ldr	x0, [sp, 112]	//, threads
	bl	free		//
// IRIW_Relax.cpp:390:     return 0;
	mov	w0, 0	// _164,
// IRIW_Relax.cpp:391: }
