...
class L1Cache(L1Cache_Controller):
    ...
    def __init__(self, system, ruby_system, cpu, cluster_id, number_of_L2s=1):
        ...
        self.L1Dcache = RubyCache(
            ...
            start_index_bit=self.getBlockSizeBits(system), is_icache=False
        )
        # self.cache = RubyCache(
        #     size="64kB", assoc=8, start_index_bit=self.getBlockSizeBits(system), is_icache=False
        # )
        self.l2_id = cluster_id
        self.l2_select_num_bits = int(math.log(number_of_L2s, 2))
...
class L2Cache(L2Cache_Controller):
    ...
    def __init__(self, system, ruby_system):
        ...
        self.L2cache = RubyCache(
            ...
            # size="1536kB", assoc=8, start_index_bit=self.getBlockSizeBits(system)
...
def make_l1_cache(system, ruby_system, cpu, cluster_id, number_of_L2s=1):
    return L1Cache(system, ruby_system, cpu, cluster_id, number_of_L2s)
