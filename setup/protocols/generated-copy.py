...
if buildEnv["PROTOCOL"] != "GENERATED":
    print("Current protocol:", buildEnv["PROTOCOL"])
    fatal("This system assumes GENERATED!")
...
def make_l1_cache(system, ruby_system, cpu, cluster_id=0):
    return L1Cache(system, ruby_system, cpu)

def make_l2_cache(system, ruby_system):
    panic("L2 Cache not supported")
