...
class DirController(Directory_Controller):
    ...
    def __init__(self, system, ruby_system, ranges, mem_ctrl):
...
def make_dir(system, ruby_system, range, mem_ctrl):
    return DirController(system, ruby_system, [range], mem_ctrl)
